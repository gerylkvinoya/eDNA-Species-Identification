...
# and outputs into one mult-FASTA file
#
# Authors:
#   Geryl Vinoya
#   Charlie Benning
...
########################################################
# read_fasta__q_file -- parse fastq file using pysam.FastxFile
#
...
def searchBarcodeDir(dirname):
    ...
    writeFasta("multi_fasta_pass.fasta", sequenceList, dirname)
...
open("multi_fasta_pass.fasta", 'w').close() #empty the file contents first
